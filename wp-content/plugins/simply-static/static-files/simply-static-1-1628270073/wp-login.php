		...
		<form name="loginform" id="loginform" action="/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/makewithani/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Make With Ani</a>		</p>
			</div>
	<script src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script id="zxcvbn-async-js-extra">
var _zxcvbnSettings = {"src":"http:\/\/localhost\/makewithani\/wp-includes\/js\/zxcvbn.min.js"};
</script>
...
var userProfileL10n = {"user_id":"0","nonce":"2b3bca5fae"};
</script>
